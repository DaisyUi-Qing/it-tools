...
<template>
  <div flex flex-col gap-4>
    ...
    <c-input-text v-model:value="secret" raw-text placeholder="请输入秘钥..." label="秘钥" clearable />
    ...
    <input-copyable v-model:value="hmac" type="textarea" placeholder="HMAC的结果..." label="文本的 HMAC" />
